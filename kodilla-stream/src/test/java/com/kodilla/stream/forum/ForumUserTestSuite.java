...
class ForumUserTestSuite {
    ...
    void testGetLocationsOfFriendsOfFriends() {
        ...
        assertEquals(3, user1.getLocationsOfFriendsFriends().size());
        assertTrue(user1.getLocationsOfFriendsFriends().contains("Key West"));
        assertTrue(user1.getLocationsOfFriendsFriends().contains("Washington"));
        assertTrue(user1.getLocationsOfFriendsFriends().contains("Miami"));
        assertFalse(user1.getLocationsOfFriendsFriends().contains("Orlando"));
    }
}